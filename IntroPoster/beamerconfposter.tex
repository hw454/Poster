...
\setbeamercolor{titlelike}         {bg=jblue,fg=charcoal}
...
% set colors for boxed blocks (blocks with frame)
\setbeamercolor{block boxed title}{fg=black,bg=jblue}
\setbeamercolor{block boxed body}{fg=black,bg=white}
...
\setbeamertemplate{title page}[default][colsep=4pt,rounded=true]
\setbeamertemplate{sections/subsections in toc}[square]
\setbeamertemplate{items}[circle]
\setbeamertemplate{blocks}[width=0.2]
 ...
 \hspace{0.5in}
  ...
  \begin{columns}
   ...
   \begin{column}{1.2\linewidth}
    ...
    \begin{mdframed}[backgroundcolor=white,leftmargin=10cm,rightmargin=10cm, userdefinedwidth=0.99\linewidth]

    \begin{columns}
   \begin{column}{\sepwid}
   \end{column} 
    \begin{column}{1.4\twocolwid}
    \centering
    \raggedright
    \usebeamercolor{title in headline}{\color{jblue}\Huge{\textbf{\inserttitle}}\\[0.5ex]}
    \usebeamercolor{author in headline}{\color{MidnightBlue}\Large{\insertauthor}\\[0.65ex]}
    {\color{ddblue}\large{{} \\[0.9ex]}}
  
 {\color{ddblue} \large{ {Supervisors \supervisor,  \cosupervisor} \\[0.9ex]}}
   \usebeamercolor{institute in headline}{\color{ForestGreen}\large{\insertinstitute}\\[0.9ex]}
\end{column}
\begin{column}{0.05\sepwid}
 \end{column} % Empty spacer column

\begin{column}{0.85\threecolwid}

   { \includegraphics[width=1.2\linewidth, left]{\logo}\\[4ex]}
...
\setbeamertemplate{block begin}
{
  ...
  \begin{beamercolorbox}[colsep*=1ex,dp={2ex},center]{block title}
    \vskip-0.25cm
  ...
  {\ifbeamercolorempty[bg]{block body}{}{\nointerlineskip\vskip-0.5pt}{\renewcommand{\baselinestretch}{1.5}} }
